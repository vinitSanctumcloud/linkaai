                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 px-4 py-1">
                        {agentDetails?.prompts
                            ...
                            .map((prompt) => (
                                <button
                                    key={prompt.id}
                                    className="w-full text-base font-extralight text-[8px] bg-white text-gray-800 py-1 px-1 rounded-lg hover:bg-gray-100 transition-all duration-200 shadow-sm border border-gray-200 hover:border-gray-300"
                                    onClick={() => {
